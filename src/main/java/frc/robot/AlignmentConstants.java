...
public class AlignmentConstants {
    ...
    public static final Pose2d INTO_BLUE_SPEAKER = new Pose2d(0.44, 5.53, Rotation2d.fromDegrees(180.0)); // prev=0.2
    ...
    public static final Pose2d INTO_RED_SPEAKER = new Pose2d(16.09, 5.56, Rotation2d.fromDegrees(0.0)); // prev=16.26
