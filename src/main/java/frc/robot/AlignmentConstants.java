...
public class AlignmentConstants {
    ...
    public static final Pose2d BLUE_SOURCE_CENTER = new Pose2d(15.36 - 0.08, 1.04 + 0.08,
            Rotation2d.fromDegrees(-57.69)); // ID 1 & 2
    public static final Pose2d BLUE_SOURCE_RIGHT = new Pose2d(14.79 - 0.05, 0.73 + 0.05,
            Rotation2d.fromDegrees(-57.69));

    public static final Pose2d BLUE_AMP = new Pose2d(1.86, 7.60, Rotation2d.fromDegrees(-90.0)); // ID 6

    public static final Pose2d BLUE_SPEAKER = new Pose2d(1.34, 5.53, Rotation2d.fromDegrees(180.0)); // ID 7 & 8 ** 180
                                                                                                     // needs to be
                                                                                                     // added NEED TO
                                                                                                     // FACE AWAY FOR
                                                                                                     // SHOT
    ...
    public static final Pose2d RED_SOURCE_CENTER = new Pose2d(1.20 + 0.05, 1.11 + 0.05,
