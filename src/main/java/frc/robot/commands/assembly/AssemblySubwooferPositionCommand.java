...
public class AssemblySubwooferPositionCommand extends SequentialCommandGroup {
    ...
    public AssemblySubwooferPositionCommand(ArmChassisPivotSubsystem ACPSubsystem, ArmShintakeMessenger armShintakeMessenger,
        ...
        addCommands(
            ...
            // Command 1
            new ACPGoToPositionCommand(ACPSubsystem, Constants.NOTE_SCORE_SUBWOOFER_SPEAKER_POSITION_ACP)
                .alongWith(new InstantCommand(() -> SmartDashboard.putString("Subwoofer stage", "STAGE 2"))),
            // Command 2

            new STPGoToPositionCommand(STPSubsystem, Constants.NOTE_SCORE_SUBWOOFER_SPEAKER_POSITION_STP)
