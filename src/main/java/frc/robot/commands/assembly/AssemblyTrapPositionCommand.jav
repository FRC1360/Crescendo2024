...
public class AssemblyTrapPositionCommand extends SequentialCommandGroup {
    ...
    public AssemblyTrapPositionCommand(ArmChassisPivotSubsystem ACPSubsystem, ArmShintakeMessenger armShintakeMessenger,
        ...
        addCommands(
            ...
            // Command 1
            new ACPGoToPositionCommand(ACPSubsystem, Constants.NOTE_SCORE_AMP_SPEAKER_POSITION_ACP)
                .alongWith(new InstantCommand(() -> SmartDashboard.putString("Amp stage", "STAGE 2"))),
            // Command 2

            new STPGoToPositionCommand(STPSubsystem, Constants.NOTE_SCORE_AMP_SPEAKER_POSITION_STP)
