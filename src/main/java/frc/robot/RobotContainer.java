...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    right_controller.button(1)
        .and(
            () -> (this.LEVEL.equals(ASSEMBLY_LEVEL.SUBWOOFER) || this.LEVEL.equals(ASSEMBLY_LEVEL.SUBWOOFER_DEFENDED)))
    ...
    operator_controller.leftBumper().whileTrue(
        new ACPMoveManual(armChassisPivotSubsystem, () -> operator_controller.getRightY(), operator_controller));
