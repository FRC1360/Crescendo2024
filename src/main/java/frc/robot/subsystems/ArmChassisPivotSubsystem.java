...
public class ArmChassisPivotSubsystem extends SubsystemBase {
    ...
    public ArmChassisPivotSubsystem() {
        ...
        this.movePIDController = new PIDController(kP, kI, kD); // kP = 0.02 || 0.14, 0.0, 0.0
        ...
        this.ACPFeedForward = new ArmFeedforward(kS, kG, kV); // kG = 0.001 || 0.0, 0.0005, 0.0
    ...
    public void updateSmartDashboard() {
        ...
        Preferences.getDouble("ACP FeedForward kS", kS);
